...
QGisLidarPluginGui::QGisLidarPluginGui( QWidget* parent, Qt::WFlags fl )
    : QDialog( parent, fl )
{
  setupUi( this );
...
QGisLidarPluginGui::~QGisLidarPluginGui()
{
}

void vGui::on_buttonBox_accepted()
{
  //close the dialog
  accept();
}

void QGisLidarPluginGui::on_buttonBox_rejected()
{
  reject();
}

void QGisLidarPluginGui::on_buttonBox_helpRequested()
{
